...
$(function(){
	...
	$.post("/x4/user/findUser",{},function (data) {
		//console.log(data);
		if (data){
			var str='';
			for (var i=0;i<data.length;i++){
				str+='<font color="red"><option value="'+data[i].id+'">'+data[i].rolename+'</option></font>'
	...
	$("#userForm").submit(function () {
		$.post("/x4/user/addUser",$(this).serialize(),function (data) {

			if (data){
				location.href="http://localhost/x4/jsp/userlist.jsp"
			}
		})
		return false;
	})
