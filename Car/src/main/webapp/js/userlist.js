...
$("#queryUser").submit(function () {
    $.get("/x4/user/findByQuery", $(this).serialize(), function (data) {
        //  console.log(data);

        if (data.username) {
            load(1, 5, data.username, null);
        } else if (data.userrole) {
            load(1, 5, null, data.userrole);
...
$(function () {
    ...
    $.get("/x4/user/role", {}, function (data) {
        //console.log(data);
        var str = '';
        if (data) {
