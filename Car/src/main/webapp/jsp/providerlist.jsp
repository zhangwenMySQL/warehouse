...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="#" id="proForm">
				<input name="method" value="query" type="hidden">
				<span>供应商编码：</span>
				<input name="queryProCode" type="text" >
				
				<span>供应商名称：</span>
				<input name="queryProName" type="text" >
        ...
        <!--供应商操作表格-->
        <table class="providerTable" cellpadding="0" cellspacing="0" id="proTable">
<%--            <tr class="firstTr">--%>
