...
<div class="right">
    ...
    <div class="search">
        <form method="get" action="#" id="queryUserIssue">
            <%--					<input name="method" class="input-text" type="hidden">--%>
            <span>车辆品牌名称：</span>
            <input name="carBrand" class="input-text" type="text">

            <span>审核状态：</span>
            <select name="carCheck" id="carCheck">
            ...
            <input value="查 询" type="submit" id="searchbutton">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="userIssueAdd.jsp" id="searchbutton">  &nbsp;&nbsp;  发 布 车 辆</a>
            <%--					<c:if test="${user.userPosition==0 || user.userPosition==5}">--%>
            <%--					 <a href="${pageContext.request.contextPath}/jsp/useradd.jsp" >添加用户</a>--%>
            <%--					</c:if>--%>
        </form>
    </div>
    <!--用户-->
    <table class="providerTable" cellpadding="0" cellspacing="0" id="user_issue">
        <%--                <tr class="firstTr">--%>
        <%--                    <th width="10%">用户编码</th>--%>
        <%--                    <th width="20%">用户名称</th>--%>
        <%--                    <th width="10%">性别</th>--%>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/userIssue.js"></script>
