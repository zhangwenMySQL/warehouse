...
<div class="right">
    ...
    <div class="search">
        <form method="get" action="#" id="queryIndent">
            <span>订单编码：</span>
            <input name="indentNo" class="input-text" type="text">
    ...
    <!--用户-->
    <table class="providerTable" cellpadding="0" cellspacing="0" id="indent_table">
        <%--                <tr class="firstTr">--%>
        <%--                    <th width="10%">用户编码</th>--%>
        <%--                    <th width="20%">用户名称</th>--%>
        <%--                    <th width="10%">性别</th>--%>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/indentList.js"></script>
